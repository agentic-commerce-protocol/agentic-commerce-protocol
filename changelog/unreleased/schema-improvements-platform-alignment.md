...
- **OrderConfirmation:** Added optional `customer_note` to echo order notes on confirmation.
...
- `examples/unreleased/examples.agentic_checkout.json` — added `company`, `order_notes`, `order_number`, `client_reference_id`, and `confirmation.customer_note` to relevant examples
