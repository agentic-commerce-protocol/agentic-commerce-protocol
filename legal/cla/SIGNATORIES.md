...
| PayPal, Inc. | 2026-04-01 | cmonty-paypal | cmonty-paypal,sjparsons,bbcoumes,pranshu-10,jvujjini,sioked,wsbrunson,shubhamkokul,wenjiezhou,remotevision,zvuki,nmikhol,praneethiyyapu,mokinator | #210 |
...
- **Individual Contributors:** Sign automatically via CLA Assistant when submitting your first PR. See [INDIVIDUAL.md](INDIVIDUAL.md)
- **Corporate Contributors:** Create a GitHub issue following instructions in [CORPORATE.md](CORPORATE.md)

## Reference

Per Section 2.4 of the Collaboration and Governance Agreement:
- All contributions must be licensed under the Project CLA
- Copyright remains with contributors, subject to CLA and Apache 2.0 License grants
- All third-party contributors must execute the CLA prior to contribution acceptance
