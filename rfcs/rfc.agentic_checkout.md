...
- Provide a **stable, versioned** API surface (`API-Version: 2025-09-30`) that ChatGPT calls to create, update, retrieve, complete, and cancel checkout sessions.
...
- [ ] Enforces HTTPS, JSON, and `API-Version: 2025-09-30`
